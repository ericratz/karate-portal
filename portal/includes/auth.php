...
// ── Session hardening ─────────────────────────────────────────
// Cookie params live in config.php so checkin.php gets the identical flags.
...
$__csp_report_url = (site_is_https() ? 'https' : 'http') . '://' . ($_SERVER['HTTP_HOST'] ?? '') . '/karate/portal/api/csp_report.php';
