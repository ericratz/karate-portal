<?php
// React SPA shell for the instructor portal — same bundle as the parent and
// student shells (frontend/ builds into parent/dist/ with an absolute base
// URL). Server-side role gate matches the old instructor pages; the
// api/v1/instructor endpoints re-check instructor/admin on every request.
...
<title>Instructor — Shotokan Karate Portal</title>
